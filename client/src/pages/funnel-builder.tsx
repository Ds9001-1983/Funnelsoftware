...
const buildingBlocks = [
  ...
  },
  {
    ...
    text: "Ein Klick, und der Funnel ist live. Deine eigene Domain verbindest du per CNAME — das SSL-Zertifikat wird automatisch eingerichtet, meist in wenigen Minuten. Kein Hosting-Setup, keine Server-Administration.",
  },
  {
    icon: ShieldCheck,
